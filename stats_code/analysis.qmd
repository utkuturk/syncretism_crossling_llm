...
behavioral_findings <- tribble(
  ...
  # --- ENGLISH ---
  "English", "Wagers et al. (2009)", "Error %", 48, "Yes (30% increase)", "N/A", "Strong attraction in ungrammatical, weak in grammatical",
  "English", "Lago et al. (2015)", "RT (ms)", 64, "Yes (~50ms)", "N/A", "Attraction facilitates ungrammatical verbs",
  "English", "Dillon et al. (2013)", "RT (ms)", 40, "Yes", "N/A", "Attraction in agreement but not reflexives",


  # --- TURKISH ---
  "Turkish", "[Enter study]", "[Measure]", NA, "[Effect]", "[Effect]", "[Key finding]",

  # --- GERMAN ---
  "German", "Hartsuiker et al. (2003)", "Error %", 24, "Yes", "N/A", "Cross-linguistic attraction in production",
  "German", "[Enter study]", "[Measure]", NA, "[Effect]", "[Effect]", "[Key finding]",

  # --- RUSSIAN ---
  "Russian", "Slioussar & Malko (2016)", "Error %", 48, "Yes", "Yes (reduced)", "Case marking reduces attraction",
  "Russian", "[Enter study]", "[Measure]", NA, "[Effect]", "[Effect]", "[Key finding]"
)
...
english_behavioral <- tribble(
  ...
  # Grammatical conditions (singular verb with singular head)
  "SG-SG-SG", "sg", "sg", "sg", "yes", 93, 3.0, "Wagers et al. (2009)",
  "SG-PL-SG", "sg", "pl", "sg", "yes", 91, 3.7, "Wagers et al. (2009)",
  # Ungrammatical conditions (plural verb with singular head)
...
# Enter Turkish behavioral data here
# If you have data on syncretism effects, include both syncretic and non-syncretic conditions
turkish_behavioral <- tribble(
  ~Condition, ~Head_Num, ~Attr_Num, ~Verb_Num, ~is_syn, ~Mean, ~SE, ~Source,
  # Syncretic conditions (nominative-accusative syncretism)
  "SYN-SG-SG-SG", "sg", "sg", "sg", "yes", NA, NA, "[Enter source]",
  "SYN-SG-PL-SG", "sg", "pl", "sg", "yes", NA, NA, "[Enter source]",
  "SYN-SG-SG-PL", "sg", "sg", "pl", "yes", NA, NA, "[Enter source]",
  "SYN-SG-PL-PL", "sg", "pl", "pl", "yes", NA, NA, "[Enter source]",
  # Non-syncretic conditions (distinctive case marking)
  "NSYN-SG-SG-SG", "sg", "sg", "sg", "no", NA, NA, "[Enter source]",
  "NSYN-SG-PL-SG", "sg", "pl", "sg", "no", NA, NA, "[Enter source]",
  "NSYN-SG-SG-PL", "sg", "sg", "pl", "no", NA, NA, "[Enter source]",
  "NSYN-SG-PL-PL", "sg", "pl", "pl", "no", NA, NA, "[Enter source]"
) %>%
  mutate(
    Language = "Turkish",
    Match = ifelse(Head_Num == Attr_Num, "Match", "Mismatch"),
...
turkish_behavioral %>%
  ...
  kable(
    caption = "Turkish Behavioral Data: [Enter measure]",
    digits = 1
  ) %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
```
...
german_behavioral <- tribble(
  ~Condition, ~Head_Num, ~Attr_Num, ~Verb_Num, ~is_syn, ~Mean, ~SE, ~Source,
  # Enter German behavioral data
  "SG-SG-SG", "sg", "sg", "sg", "yes", NA, NA, "[Enter source]",
  "SG-PL-SG", "sg", "pl", "sg", "yes", NA, NA, "[Enter source]",
  "SG-SG-PL", "sg", "sg", "pl", "yes", NA, NA, "[Enter source]",
  "SG-PL-PL", "sg", "pl", "pl", "yes", NA, NA, "[Enter source]"
) %>%
  mutate(
    Language = "German",
    Match = ifelse(Head_Num == Attr_Num, "Match", "Mismatch"),
...
german_behavioral %>%
  ...
  select(Condition, Grammaticality, Match, Mean, SE, Source) %>%
  kable(
    caption = "German Behavioral Data: [Enter measure]",
    digits = 1
  ) %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
```
...
russian_behavioral <- tribble(
  ~Condition, ~Head_Num, ~Attr_Num, ~Verb_Num, ~is_syn, ~Mean, ~SE, ~Source,
  # Syncretic conditions
  "SYN-SG-SG-SG", "sg", "sg", "sg", "yes", NA, NA, "[Enter source]",
  "SYN-SG-PL-SG", "sg", "pl", "sg", "yes", NA, NA, "[Enter source]",
  "SYN-SG-SG-PL", "sg", "sg", "pl", "yes", NA, NA, "[Enter source]",
  "SYN-SG-PL-PL", "sg", "pl", "pl", "yes", NA, NA, "[Enter source]",
  # Non-syncretic conditions
  "NSYN-SG-SG-SG", "sg", "sg", "sg", "no", NA, NA, "[Enter source]",
  "NSYN-SG-PL-SG", "sg", "pl", "sg", "no", NA, NA, "[Enter source]",
  "NSYN-SG-SG-PL", "sg", "sg", "pl", "no", NA, NA, "[Enter source]",
  "NSYN-SG-PL-PL", "sg", "pl", "pl", "no", NA, NA, "[Enter source]"
...
russian_behavioral %>%
  ...
  select(Condition, Syncretism, Grammaticality, Match, Mean, SE, Source) %>%
  kable(
    caption = "Russian Behavioral Data: [Enter measure]",
    digits = 1
  ) %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
```
