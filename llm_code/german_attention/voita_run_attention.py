...
def _log_bert_voita_progress(i, total_rows, correct, total, skipped_too_long, skipped_no_span):
    ...
    print(
        f"[BERT-Voita] {i}/{total_rows} ({progress_pct:.1%}) | "
        # f"mean head accuracy so far: {mean_acc:.4f} ({mean_acc:.2%}) | "
